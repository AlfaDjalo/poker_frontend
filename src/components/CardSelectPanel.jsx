 ...
 * === "CARD_SELECT" (e.g. drawmaha's discard/draw step). Card picking
 * itself is NOT handled here — the caller's existing card-click
 * handler (GameSimulator's togglePlayerCard, already wired to
 * onPlayerCardClick) is what puts cards into `selectedCards`. This
 ...
 *   maxCount      - decision.options[0].max_count — same, raw.
...
const CardSelectPanel = ({
    ...
    const requirementText = !countsKnown
